...
DB = {
  ...
  updateProject: function(local, distant) {
    var comment, task, u, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
    ...
    _ref5 = local.comments;
    for (_m = 0, _len4 = _ref5.length; _m < _len4; _m++) {
      comment = _ref5[_m];
      delete comment.oldID;
    }
...
synappseApp.controller('CommentCtrl', function($scope, $routeParams, Projects) {
  $scope.createComment = function(taskID, comment) {
  ...
  return $scope.deleteComment = function(commentID) {
    return Projects.deleteComment($scope.project.id, commentID, $scope.comment);
  };
});
...
synappseApp.factory('Projects', function() {
  ...
  factory.deleteComment = function(projectID, commentID) {
    ...
    for (_i = 0, _len = Projects.length; _i < _len; _i++) {
      ...
      project.deletedComments.push(((function() {
        var _j, _len1, _ref, _results;
        _ref = project.comments;
        _results = [];
        for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
