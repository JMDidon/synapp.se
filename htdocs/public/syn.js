...
DB = {
  ...
  renameProject: function(oldFolder, newFolder) {
    var $this;
    $this = this;
    return this.client.move(oldFolder, newFolder, function(error, stat) {
      if (error) {
  ...
  updateProject: function(local, distant) {
    var supposedFolder, task, u, _i, _j, _len, _len1, _ref, _ref1, _ref2;
    supposedFolder = this.folder + (slug(local.name)) + '/';
    if (distant.folder !== supposedFolder) {
      this.renameProject(distant.folder, supposedFolder);
    }
