...
DB = {
  ...
  init: function() {
    var $this;
    $this = this;
    return load(['//ajax.googleapis.com/ajax/libs/angularjs/1.2.9/angular.js', '//ajax.googleapis.com/ajax/libs/angularjs/1.2.9/angular-route.min.js', 'public/lib/angular-translate.min.js', 'public/app.js'], function() {
