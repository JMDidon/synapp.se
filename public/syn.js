...
DB = {
  ...
  init: function() {
    ...
    return async('public/app.css', function() {
      return async('//ajax.googleapis.com/ajax/libs/angularjs/1.2.9/angular.min.js', function() {
        return async('//ajax.googleapis.com/ajax/libs/angularjs/1.2.9/angular-route.min.js', function() {
          return async('public/app.js', function() {
...
(function() {
  DB.checkAuth();
  return (document.getElementById('dbauth')).addEventListener('click', function() {
    return DB.auth();
  });
})();
