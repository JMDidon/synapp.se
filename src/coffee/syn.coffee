...
DB = 
	...
	init: ->
		$this = @
		load ['//ajax.googleapis.com/ajax/libs/angularjs/1.2.9/angular.js', '//ajax.googleapis.com/ajax/libs/angularjs/1.2.9/angular-route.min.js', 'public/angular-translate.min.js', 'public/app.js'], ->
